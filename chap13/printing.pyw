...
class Statement(object):
    ...
    def balance(self):
        return sum([amount for data, amount in self.transactions])
    ...
    def printViaQPainter(self):
        ...
        for statement in self.statements:
            ...
            if balance < 0:
                ...
                text = ("We are delighted to have you done business "
                        "with you")
            painter.drawText(x, y, text)
            painter.setPen(Qt.black)
            y += int(serifLineHeight * 1.5)
            painter.drawText(x, y, "Transaction:")
            y += serifLineHeight
            ...
            y += serifLineHeight
            x = LeftMargin
            painter.drawText(x, y, "We hope continue doing "
                                   "business with you,")
            y += serifLineHeight
